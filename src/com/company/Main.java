...
public class Main {
    ...
    public static int[] heroesDamage = {13, 20, 30, 0};
    ...
    public static void workMedic() {
        ...
        for (int i = 0; i < heroesDamage.length; i++) {
            ...
            if (heroesHealth[i] > 0 && heroesHealth[i] < 100) {
                heroesHealth[i] = heroesHealth[i] + 39;
            }

            System.out.println("Medic cured " + heroesAttackType[i]);
            break;
